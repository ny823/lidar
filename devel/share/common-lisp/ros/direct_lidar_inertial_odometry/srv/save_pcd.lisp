...
(cl:in-package direct_lidar_inertial_odometry-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <save_pcd-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'save_pcd-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name direct_lidar_inertial_odometry-srv:<save_pcd-request> is deprecated: use direct_lidar_inertial_odometry-srv:save_pcd-request instead.")))

(cl:ensure-generic-function 'leaf_size-val :lambda-list '(m))
(cl:defmethod leaf_size-val ((m <save_pcd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader direct_lidar_inertial_odometry-srv:leaf_size-val is deprecated.  Use direct_lidar_inertial_odometry-srv:leaf_size instead.")
  (leaf_size m))

(cl:ensure-generic-function 'save_path-val :lambda-list '(m))
(cl:defmethod save_path-val ((m <save_pcd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader direct_lidar_inertial_odometry-srv:save_path-val is deprecated.  Use direct_lidar_inertial_odometry-srv:save_path instead.")
  (save_path m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<save_pcd-request>)))
  ...
  "direct_lidar_inertial_odometry/save_pcdRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'save_pcd-request)))
  "Returns string type for a service object of type 'save_pcd-request"
  "direct_lidar_inertial_odometry/save_pcdRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <save_pcd-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'save_pcd-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name direct_lidar_inertial_odometry-srv:<save_pcd-response> is deprecated: use direct_lidar_inertial_odometry-srv:save_pcd-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <save_pcd-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader direct_lidar_inertial_odometry-srv:success-val is deprecated.  Use direct_lidar_inertial_odometry-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<save_pcd-response>)))
  ...
  "direct_lidar_inertial_odometry/save_pcdResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'save_pcd-response)))
  "Returns string type for a service object of type 'save_pcd-response"
  "direct_lidar_inertial_odometry/save_pcdResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'save_pcd)))
  ...
  "direct_lidar_inertial_odometry/save_pcd")